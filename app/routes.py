...
from app.forms import EditProfileForm, LoginForm, RegistrationForm, EmptyForm, PostForm, ResetPasswordForm, ResetPasswordRequestForm
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        flash('Check your email for instructions to reset')
        return redirect(url_for('index'))
    return render_template(
